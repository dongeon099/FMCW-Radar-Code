...
def _lane_bounds():
    lane_width = _get_config_value("LANE_WIDTH", X_RANGE * 2.0)  # EKF added: match MultiLaneEKFTracker lane split.
    ego_center_x = _get_config_value("EGO_LANE_CENTER_X", 0.0)  # EKF added
    half_lane = lane_width / 2.0
    return [
        ("Lane 1", ego_center_x - 1.5 * lane_width, ego_center_x - half_lane, "tab:orange", "^"),
        ("Lane 2", ego_center_x - half_lane, ego_center_x + half_lane, "tab:blue", "o"),
        ("Lane 3", ego_center_x + half_lane, ego_center_x + 1.5 * lane_width, "tab:green", "s"),
    ]
