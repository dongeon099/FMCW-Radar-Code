...
from network_sender import LANE_ID_UNKNOWN, RadarUDPSender, prepare_udp_objects
...
def send_udp_result(
    ...
    udp_sender.send_radar_result(
        ...
        vehicle_state={
            "ego_speed_kmh": spi_sender.last_ego_speed_raw,
            "ego_speed_mps": spi_sender.last_ego_speed_mps,
            "steering_angle_deg": spi_sender.last_steering_angle_deg,
            "turn_signal": spi_sender.last_turn_signal,
            "miso_valid": spi_sender.last_miso_valid,
            "spi_sequence": spi_sender.last_miso_sequence,
            "spi_valid_count": spi_sender.valid_miso_count,
            "spi_invalid_count": spi_sender.invalid_miso_count,
        },
        advice=advice,
    )
